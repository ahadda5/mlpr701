...
ds = FashionMnist('/home/ashraf.haddad/mlpr/fashion-mnist/')
...
model_adv, _ = make_and_restore_model(arch='resnet50', dataset=ds,
              resume_path= '/home/ashraf.haddad/mlpr/FashionMnistAdv50/checkpoint.pt.best') #'/tmp/35daedae-1b39-4941-ad08-8bd6459c1bd8/checkpoint.pt.best')
...
torch.save(model.state_dict(), "./FashionSTD50NetRobseT")
model = MnistResNet()
model_state_dict = torch.load("./FashionSTD50NetRobseT")
